...
<div class="max-w-5xl mx-auto p-6">
  ...
  <div class="mt-4 bg-white/5 border border-white/10 rounded-2xl p-6">
    ...
    <div class="w-24 h-24 overflow-hidden rounded-2xl">
    ...
    <div class="mt-4 grid grid-cols-1 md:grid-cols-3 gap-3">
      ...
      <div class="bg-white/5 border border-white/10 rounded-xl p-4">
        ...
        <div class="font-semibold"><?= htmlspecialchars($profile['exp'] ?? '—') ?></div>
      </div>
    </div>
    ...
    <?php else: ?>
      <div class="p-4 space-y-3">
        <?php foreach ($dispos as $d): ?>
          <div class="flex items-center justify-between gap-4 bg-white/5 border border-white/10 rounded-2xl p-4 hover:bg-white/10 transition">
            <div>
